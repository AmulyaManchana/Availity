...
Git:
    ...
    git clone <Will update the git url>
...
The project has build scripts for both Maven and follows the standard directory structure used in most Serenity Avility projects:
```Gherkin
src
  + main
  + test
...
Both variations of the dommy project scenarios
